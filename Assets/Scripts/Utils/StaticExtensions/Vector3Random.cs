...
public static class Vector3Utility
{
    ...
    public static void Randomnize(this ref Vector3 myVector)
    {
        myVector = new Vector3(UnityEngine.Random.Range(-1f,1f), UnityEngine.Random.Range(-1f,1f), UnityEngine.Random.Range(-1f, 1f));
    }
}